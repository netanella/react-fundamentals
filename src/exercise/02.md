...
React is declarative - it abstracts away the imperative browser API.

Imperative vs declarative: Imperative is _how_ you do something, declarative is
_what_ you do. In declarative code we describe what we want to achieve, without
instructing how to do it. This allows the program to work in different contexts,
where the imperative instructions may differ.

React is for creating elements. React DOM is for taking those react elements and
putting them on the page.

React DOM is different on each platform (web, native), React is the same.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=netanella1%40gmail.com).
